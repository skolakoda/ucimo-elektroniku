...
Veliki solenoidni ventil ima veću propusnost ali teže mu je obezbediti napajanje (klasične baterije ne daju 12V). Neka od mogućih rešenja su:
- automobilski akumulator 
- solarna ploča + kontroler
- power bank
