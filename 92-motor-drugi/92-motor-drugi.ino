...
int speedpin = 3; // crveni -> ENA (PWM speed regulation)
int pinI1 = 5;    // plavi -> IN1
int pinI2 = 6;    // crni -> IN2

// desetka ne radi?
int speedpin2 = 9; // žuti -> ENB (PWM speed regulation)
int pinI3 = 10;    // crni -> IN3
int pinI4 = 11;    // plavi -> IN4
